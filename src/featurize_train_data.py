...
import pandas as pd
import numpy as np
from featurize import IntensityBands, DataStats
import csv
...
if __name__ == '__main__':
    participants = [i for i in range(1, 20)]
    activities = [i for i in range(1, 4)]
    df = pd.read_csv('data/merged_data.txt')
    logging.basicConfig(filename='errors/log_errors.Log', level=logging.DEBUG)
